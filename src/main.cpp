...
uint256 hashGenesisBlock("0xe725dd8f5c57279beea011d420de2c7aeed20e82bf5434e7ebc1502963242f33");
...
const string strMessageMagic = "SuxCoin Signed Message:\n";
...
{
    int64 nSubsidy = 10000 * COIN; //Amt of coins per block
	
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // SuxCoin: 1 days
static const int64 nTargetSpacing = 1; // SuxCoin: 1 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal SuxCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SuxCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
